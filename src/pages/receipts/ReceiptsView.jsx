...
import { getReceipts } from "../../services/SAP/receiptService.js";
...
export default function ReceiptsView() {
  ...
  const {
    ...
    totalPages,
    totalItems,
  } = useServerPagination(getReceipts, {
    defaultSort: "DocDate",
    defaultSortDir: "desc",
    pageSize: 10,
    autoFetch: true,
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className=" /70">
          Visualización de boletas (solo lectura)
        </p>
      </div>

      {/* Filtros */}
      <GenericFilters
        searchPlaceholder="Buscar boletas (DocNum, DocEntry, Proveedor, Referencia)..."
        searchValue={search}
      ...
      <GenericTable
        ...
        data={receipts}
        pageData={receipts}
        emptyMessage="No hay boletas registradas"
        emptyIcon={FileText}
        searchQuery={search}
