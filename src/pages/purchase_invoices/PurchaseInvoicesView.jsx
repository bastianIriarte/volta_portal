...
import { getPurchaseInvoices } from "../../services/SAP/purchaseInvoiceService.js";
...
export default function PurchaseInvoicesView() {
  ...
  const {
    ...
    totalPages,
    totalItems,
  } = useServerPagination(getPurchaseInvoices, {
    defaultSort: "DocDate",
    defaultSortDir: "desc",
    pageSize: 10,
    autoFetch: true,
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className=" /70">
          Visualización de facturas de compra (solo lectura)
        </p>
      </div>

      {/* Filtros */}
      <GenericFilters
        searchPlaceholder="Buscar facturas de compra  (DocNum, DocEntry, Proveedor, Referencia)..."
        searchValue={search}
