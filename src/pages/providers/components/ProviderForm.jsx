...
import { createProvider, getProviderById, updateProvider } from "../../../services/providersService";
import { handleSnackbar } from "../../../utils/messageHelpers";
import { validateField } from "../../../utils/validators";
import Loading from "../../../components/ui/Loading";
// Importar los componentes reutilizables;

const ProviderForm = ({ mode, register, onClose }) => {
    ...
    useEffect(() => {
        const loadData = async () => {
            if (mode === "edit" && register) {
                setLoading(true);
                try {
                    const response = await getProviderById(register.id);
                    if (response.success) {
    ...
    const submit = async () => {
        ...
        try {
            let response;
            if (mode === "edit") {
                response = await updateProvider(form.id, form);
            } else {
                response = await createProvider(form);
            }
